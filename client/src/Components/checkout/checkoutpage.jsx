                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md text-center">
                        ...
                        <p className="text-gray-600 mb-6">
                            Your delicious food is being prepared and will be on its way shortly.
                        </p>
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                            <div className="flex mb-6">
                                <div className="flex items-center">
                                    <div
                                        className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 1 ? 'bg-orange-500 text-white' : 'bg-orange-200 text-orange-800'}`}
                                    >
                                        1
                                    </div>
                                ...
                                <div className="flex items-center">
                                    <div
                                        className={`w-8 h-8 rounded-full flex items-center justify-center ${step === 2 ? 'bg-orange-500 text-white' : 'bg-orange-200 text-orange-800'}`}
                                    >
                                        2
                                    </div>
